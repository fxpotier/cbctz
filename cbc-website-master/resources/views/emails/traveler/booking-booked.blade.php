...
@lang('view/booking/emails.content.traveler.booked', ['experience' => $data['experience'], 'date' => $data['date'], 'time' => $data['time'], 'citizen' => $data['citizen']['firstname']])<br><br>
...
@lang('view/booking/emails.content.traveler.common.tip')<br><br>
